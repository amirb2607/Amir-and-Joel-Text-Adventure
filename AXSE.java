...
public class AXSE implements Location
{
    ...
    public void Kodak(Player p) throws InterruptedException {
       ...
       Thread.sleep(1000);
       System.out.println("Yeah sit here we are in a good spot man Kodaks a real easy teacher we just");
       Thread.sleep(1000);
       System.out.println("we just have to hand in some worksheets and she gives us a good grade.");
       System.out.println("Oh yeah this should be interesting than.");
       Thread.sleep(1000);
